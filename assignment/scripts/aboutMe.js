...
let food = "Mom's beef stroganoff";
...
let friendsPets = 3;
//NOTE TO SELF - the friend = Tyler who has Oswald & Girtie the dogs (2) and Gobbles the cat (1)
...
} //end decision about my adventurousness
...
if(friendsPets > pets){
  ...
  console.log( 'At ' + mostPets + ' pets, my friends have the most pets.' );
}  //end friends have the most pets
else if(friendsPets === pets){
  mostPets = pets;
  console.log( 'My friends and I both have ' + mostPets + ' pets! Woot!' );
} //end we have the same number of pets
else{
  mostPets = pets;
